...
print('=== nav01 ===')
train_dpf(task='nav01', data_path='data/100s', model_path='models/nav01_cnn', plot=False)
print('=== nav02 ===')
train_dpf(task='nav02', data_path='data/100s', model_path='models/nav02_cnn', plot=False)
print('=== nav03 ===')
train_dpf(task='nav03', data_path='data/100s', model_path='models/nav03_cnn', plot=False)
"
